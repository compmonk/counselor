...
async function createUser(user) {
    ...
    const firebaseResponse = await firebaseService.createUserWithEmailAndPassword(user.email,
        user.password,
    ...
    return {
        ...
        session: {
            ...
            "accessToken": firebaseResponse.user.toJSON()["stsTokenManager"].accessToken,
            "expirationTime": moment(firebaseResponse.user.toJSON()["stsTokenManager"].expirationTime)
        }
    }
}
